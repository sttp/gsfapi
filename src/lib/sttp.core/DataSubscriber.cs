...
#if NET
using MeasurementModel = Gemstone.Timeseries.Model.Measurement;
using DeviceModel = Gemstone.Timeseries.Model.Device;
using PhasorModel = Gemstone.Timeseries.Model.Phasor;
#endif
...
/// </summary>
[Description("STTP Subscriber: client that subscribes to an STTP-style publishing server for streaming data.")]
[EditorBrowsable(EditorBrowsableState.Advanced)] // Normally defined as an input device protocol
#if NET
[AdapterProtocol("STTP", "IEEE 2664 Streaming Telemetry Transport Protocol",
    ProtocolType.Measurement, UIVisibility.Input, false,
    lockedDeviceFields: [
        nameof(DeviceModel.Name),
        nameof(DeviceModel.Acronym),
        nameof(DeviceModel.AlternateAcronym),
        nameof(DeviceModel.AlternateAcronym2),
        nameof(DeviceModel.AlternateAcronym3),
        nameof(DeviceModel.AccessID),
        nameof(DeviceModel.LoadOrder),
        nameof(DeviceModel.Longitude),
        nameof(DeviceModel.Latitude),
        nameof(DeviceModel.HistorianID),
        nameof(DeviceModel.InterconnectionID),
        nameof(DeviceModel.VendorDeviceID),
        nameof(DeviceModel.CompanyID),
        nameof(DeviceModel.TimeZone),
        nameof(DeviceModel.TimeAdjustmentTicks),
        nameof(DeviceModel.ContactList),
        nameof(DeviceModel.Description),
        nameof(DeviceModel.IsConcentrator),
    ],
    lockedMeasurementFields: [
        nameof(MeasurementModel.PointTag),
        nameof(MeasurementModel.AlternateTag),
        nameof(MeasurementModel.AlternateTag2),
        nameof(MeasurementModel.AlternateTag3),
        nameof(MeasurementModel.SignalTypeID),
        nameof(MeasurementModel.PhasorSourceIndex),
        nameof(MeasurementModel.SignalReference),
        nameof(MeasurementModel.HistorianID),
        nameof(MeasurementModel.Adder),
        nameof(MeasurementModel.Multiplier),
        nameof(MeasurementModel.Description),
        nameof(MeasurementModel.Label),
        nameof(MeasurementModel.Enabled),
    ],
    lockedPhasorFields: [
        nameof(PhasorModel.Label),
        nameof(PhasorModel.AlternateLabel),
        nameof(PhasorModel.AlternateLabel2),
        nameof(PhasorModel.AlternateLabel3),
        nameof(PhasorModel.Type),
        nameof(PhasorModel.Phase),
        nameof(PhasorModel.PrimaryVoltageID),
        nameof(PhasorModel.SecondaryVoltageID),
        nameof(PhasorModel.SourceIndex),
        nameof(PhasorModel.BaseKV),
    ])]
...
#pragma warning restore 618
    ...
    {
        ConnectionAuthenticated?.SafeInvoke(this, EventArgs.Empty);
    }
    ...
    {
        ReceivedServerResponse?.SafeInvoke(this, new EventArgs<ServerResponse, ServerCommand>(responseCode, commandCode));
    }
    ...
    {
        ReceivedUserCommandResponse?.SafeInvoke(this, new UserCommandArgs(command, response, buffer, startIndex, length));
    }
    ...
    {
        MetaDataReceived?.SafeInvoke(this, new EventArgs<DataSet>(metadata));
    }
    ...
    {
        DataStartTime?.SafeInvoke(this, new EventArgs<Ticks>(startTime));
    }
    ...
    {
        ProcessingComplete?.SafeInvoke(this, new EventArgs<string>(source));
    ...
    {
        NotificationReceived?.SafeInvoke(this, new EventArgs<string>(message));
    }
    ...
    {
        ServerConfigurationChanged?.SafeInvoke(this, EventArgs.Empty);
    }
